...
const payloadresponse={userEmail:"rajesh.seleniumqa@gmail.com",userPassword:"Rajesh@143"};
...
test.beforeAll(async()=>
{
 ...
 const ApiUtils=new ApiUtils(apicontext,payloadresponse);
 ApiUtils.createorder(orderpayload);
 
//const loginresponse= await apicontext.post("https://rahulshettyacademy.com/api/ecom/auth/login",{data:payloadresponse})
...
test('place order with Api response',async({page})=>
{
    const ApiUtils=new ApiUtils(apicontext,payloadresponse);
