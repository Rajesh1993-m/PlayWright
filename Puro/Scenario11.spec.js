...
test('Scroll down home page click on vegetables category and add scalable products & increment in list page',async({page})=>
{
   ...
   const listscalableproducts=["Teenda","Delhi Carrot","Raw Pappaya"];
    ...
    await listpage.incrementscalableproducts(listscalableproducts,grammagevalue);
...
const popup=await page.locator("div[class='scalable-product-popup_right___uO2E']");
await popup.click();
   await page.locator("input[type='number']").type("500");
  const newpopups=await page.locator("div[class='scalable-product-popup_rightOne__HI1nb']");
